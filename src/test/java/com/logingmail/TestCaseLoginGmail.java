...
public class TestCaseLoginGmail {
    ...
    public void setUp() throws Exception {
        //Se utiliza WebDriverManager que ya soluciona el incnveniente de tener que actualizar el driver con la versión del navagador aporte del proefesor Boni GArciar Senior mundial en Automatización
